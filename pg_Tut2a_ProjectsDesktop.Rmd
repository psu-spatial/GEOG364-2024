...
## Projects using Rstudio Desktop {#T2_ProjectsDesktop}
...
<br>
 ...
 5. Under "create project as a subdirectory of", hit the browse button and go inside your GEOG-364 main  folder (you just need to be in the folder, you don't need to have selected anything). Press open. <br>
...
#### How do I know it's worked? {#Tut2Bc_signsRproj}
...
knitr::include_graphics('./index_images/pg_Tut2_startup_fig5.png')
```
...
knitr::include_graphics('./index_images/pg_Tut2_startup_fig6.png')
```
